 ...
 */
import {ANOTHREHOME, DOWN, GRID, HOME, LEFT, RIGHT, UP, WALL, WATER} from "./const";
import {map,isGameOver} from "./main";
...
function CheckIntersect(object1, object2, overlap)
{
	...
	var B1 = object1.x + object1.size - overlap;
	var C1 = object1.y + overlap;
	var D1 = object1.y + object1.size - overlap;
 
	var A2 = object2.x + overlap;
	var B2 = object2.x + object2.size - overlap;
	var C2 = object2.y + overlap;
	var D2 = object2.y + object2.size - overlap;
...
function tankMapCollision(tank,mapobj){
	...
	if(tank.dir === UP || tank.dir === DOWN){
		...
		for(var i=0;i<tileNum && colIndex+i < mapobj.wTileCount ;i++){
			...
			var r = (mapobj.mapLevel)[rowIndex];
			var mapContent = r[colIndex+i];
...
function bulletMapCollision(bullet,mapobj){
	...
	if(bullet.dir === UP || bullet.dir === DOWN){
		...
		for(var i=0;i<tileNum && colIndex+i < mapobj.wTileCount ;i++){
			//var mapContent = mapobj.mapLevel[rowIndex][colIndex+i];
			var mapLevelElement = mapobj.mapLevel;
			if(mapLevelElement === null){
				alert(mapLevelElement);
			}
			var r = mapLevelElement[rowIndex];
