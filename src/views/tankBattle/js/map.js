import {Num} from "./num";
import {GRASS, GRID, HOME, ICE, POS, RESOURCE_IMAGE, SCREEN_HEIGHT, SCREEN_WIDTH, WALL, WATER} from "./const";
import {map1,map2,map3,map4,map5,map6,map7,map8,map9,map10,map11,map12,map13,map14,map15,map16,map17,map18,map19,map20,map21,Maps} from "./level";
import {maxEnemy} from "./main";
